...
public class Validations {
    ...
    public static void softAssertElementIsNotHidden(WebDriver driver, By elementLocator, String message) {
        try {
            WebElement element = driver.findElement(elementLocator);
            String ariaHidden = element.getAttribute("aria-hidden");
            softAssert.assertFalse(ariaHidden.equals("false"), message);
            LoggerClass.logMessage("[SOFT VALIDATION] Element is not hidden: " + message);
        } catch (Exception e) {
            LoggerClass.logMessage("[SOFT VALIDATION FAIL] Element hidden: " + message);
        }
    }

    /**
     * Soft assertion - Validates if a web element is disabled.

    public static void softAssertElementDisabled(WebDriver driver, By elementLocator, String message) {
        try {
            boolean isDisabled;
            ...
            softAssert.assertTrue(isDisabled, message);
            LoggerClass.logMessage("[VALIDATION] Element is disabled: " + message);
        } catch (Exception e) {
            LoggerClass.logMessage("[VALIDATION FAIL] Element not disabled (enabled): " + message);
        }
    }*/
